						...
						<div class="card panel mb-3">
							...
							<div class="card-body">
								<div class="mb-3">
									...
									<input type="text" value="Sample Text" class="form-control" id="exampleInputPassword1">
								</div>
								<div class="mb-3">
									...
									<div class="col-md-6 col-12">
										<div class="mb-3">
											...
											<div class="input-group mb-3">
												...
												<input type="text" value="Sample Text" class="form-control" placeholder="00.00" aria-label="" aria-describedby="basic-addon1">
											</div>
										</div>
									</div>
									<div class="col-md-6 col-12">
								...
								<template>
									<li class="list-group-item">
										...
										<div class="mb-3">
											...
											<input type="text" value="Sample Text" placeholder="Value" class="form-control" id="exampleInputPassword1">
										</div>
									</li>
								</template>
								<li class="list-group-item">
						...
						<div class="card panel mb-3">
							...
							<div class="card-body">
								<div class="mb-3">
									...
									<input type="text" value="Sample Text" class="form-control" maxlength="70" id="exampleInputPassword1">
									<div class="form-text">
